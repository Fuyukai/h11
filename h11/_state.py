...
EventTransitionType = dict[
    ...
    dict[
        type[Sentinel],
        dict[type[Event] | tuple[type[Event], type[Sentinel]], type[Sentinel]],
    ],
]
...
class ConnectionState:
    ...
    def process_event(
        ...
        server_switch_event: type[Sentinel] | None = None,
    ) -> None:
        _event_type: type[Event] | tuple[type[Event], type[Sentinel]] = event_type
    ...
    def _fire_event_triggered_transitions(
        self,
        role: type[Sentinel],
        event_type: type[Event] | tuple[type[Event], type[Sentinel]],
    ) -> None:
